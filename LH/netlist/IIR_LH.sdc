...
# Created by write_sdc on Mon Nov 16 09:21:47 2020
...
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {a0[11]}]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {a0[10]}]
